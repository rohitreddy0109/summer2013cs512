package com.example.nallahwk6app;
...
public class HomeScreen extends Activity
{
	...
	{
	startActivityForResult(new Intent(this,Configurationpref.class), INPUT_REQUEST);
	}	
...
final Button configuration = (Button) findViewById(R.id.configpref);
...
Toast.makeText(HomeScreen.this,"activity ok, input = "+ input, Toast.LENGTH_SHORT).show();
